...
class EasyQRCodeGenerator
{
    ...
    protected $plugin_new_issue_url;
    ...
    function __construct()
    {
        ...
        $this->plugin_new_issue_url = 'https://github.com/byvex/easy-qr-code-generator/issues/new';
    ...
    function add_plugin_row_meta($links, $file)
    {
        if (plugin_basename(__FILE__) == $file) {
            $row_meta = array(
                ...
                'easy_qrcode_issue' => '<a href="' . esc_url($this->plugin_new_issue_url) . '" target="_blank" rel="noopener noreferrer" aria-label="' . esc_attr('Submit Issue') . '">' . esc_html('Submit Issue') . '</a>',
            );
    ...
    function easy_qrcode_shortcode($atts = array(), $content = null, $tag = '')
    {
        ...
        $vars = shortcode_atts(
            array(
                // 'title' => 'QR Code Title', // this will be added in next version
                // 'sub-title' => '', // this will be added in next version
                // 'html-tag' => 'h3', // this will be added in next version
                // 'category' => '', // this will be added in next version
                'alignment' => 'left',
                'dot-scale' => 1,
                'qr-level' => 'L',
                ...
                <table class="wp-list-table widefat striped table-view-list">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>logo-height</td>
                            <td>Logo Height</td>
                            <td>[easy-qrcode logo-height="60"]Your Content Here.[/easy-qrcode]</td>
                        </tr>
                        <tr>
                            <td>logo-size</td>
                            <td>Logo size</td>
                        ...
                        <tr>
                            <td>logo-width</td>
                            <td>Logo Width</td>
                            <td>[easy-qrcode logo-width="60"]Your Content Here.[/easy-qrcode]</td>
                        </tr>
                        <tr>
                            <td>colordark</td>
